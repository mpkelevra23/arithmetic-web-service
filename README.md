# Distributed Arithmetic Web Service

## Описание проекта

Этот проект представляет собой распределенную систему вычисления арифметических выражений, разработанную на языке программирования Go. Система состоит из двух основных компонентов:
...
![Архитектура системы](https://i.imgur.com/wjCZbRl.png)

### Принцип работы

1. Пользователь отправляет запрос с арифметическим выражением на оркестратор.
...
6. Пользователь может проверить статус и результат выражения через API.
...
|------------|----------|------------------------|
| PORT | Порт для HTTP-сервера оркестратора | 8080 |
